    ...
    connection.query(getData, [app_acronym], (error, result) => {
      if (error) throw error;
        ...
        if (!startDate) {
          ...
          connection.query(updateInfo, [old_startDate, app_acronym], (error, result) => {
            if (error) throw error;
          });
        } else if (startDate) {
          const updateInfo = `UPDATE application SET app_startDate = ? WHERE app_acronym = ?`;
          connection.query(updateInfo, [startDate, app_acronym], (error, result) => {
            if (error) throw error;
          });
        }
        ...
        if (!endDate) {
          ...
          connection.query(updateInfo, [old_endDate, app_acronym], (error, result) => {
            if (error) throw error;
          });
        } else {
          const updateInfo = `UPDATE application SET app_endDate = ? WHERE app_acronym = ?`;
        ...
        if (!permitOpen) {
          ...
          connection.query(updateInfo, [oldPermitOpen, app_acronym], (error, result) => {
            if (error) throw error;
          });
        } else {
          const updateInfo = `UPDATE application SET app_permitOpen = ? WHERE app_acronym = ?`;
          connection.query(updateInfo, [permitOpen, app_acronym], (error, result) => {
            if (error) throw error;
          });
        }
        ...
        if (!permitTodo) {
          ...
          connection.query(updateInfo, [oldPermitTodo, app_acronym], (error, result) => {
            if (error) throw error;
          });
        } else {
          const updateInfo = `UPDATE application SET app_permitToDo = ? WHERE app_acronym = ?`;
          connection.query(updateInfo, [permitTodo, app_acronym], (error, result) => {
            if (error) throw error;
          });
        }
        ...
        if (!permitDoing) {
          ...
          connection.query(updateInfo, [oldPermitDoing, app_acronym], (error, result) => {
            if (error) throw error;
          });
        } else {
          const updateInfo = `UPDATE application SET app_permitDoing = ? WHERE app_acronym = ?`;
          connection.query(updateInfo, [permitDoing, app_acronym], (error, result) => {
            if (error) throw error;
          });
        }
        ...
        if (!permitDone) {
          ...
          connection.query(updateInfo, [oldPermitDone, app_acronym], (error, result) => {
            if (error) throw error;
          });
        } else {
          const updateInfo = `UPDATE application SET app_permitDone = ? WHERE app_acronym = ?`;
          connection.query(updateInfo, [permitDone, app_acronym], (error, result) => {
            if (error) throw error;
          });
        }
        res.send();
